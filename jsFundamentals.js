...
ana.sayHello();
console.log(
  "Is 'ana' an instance of PersonProto? ",
...
alex.sayHello();
console.log(
  "Is 'alex' an instance of PersonConstructor? ",
  alex instanceof PersonConstructor
);
...
david.sayHello();
console.log(
  "Is 'david' an instance of PersonActions? ",
  david instanceof PersonActions
);
